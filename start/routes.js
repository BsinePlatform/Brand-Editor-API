...
Route.resource('campaign-product', 'ProductCampaignController').validator(new Map([
  [['campaign-product.store'], ['StoreCampaignProduct']],
  [['campaign-product.update'], ['UpdateCampaignProduct']]
]))
  .apiOnly()
  .middleware('auth')
...
Route.resource('gallery-permission', 'GalleryPermissionController').validator(new Map([
  [['gallery-permission.store'], ['StoreGalleryPermission']],
  [['gallery-permission.update'], ['UpdateGalleryPermission']]
]))
.apiOnly()
.middleware('auth')
